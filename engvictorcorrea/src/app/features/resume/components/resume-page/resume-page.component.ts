...
export class ResumePageComponent {
  ...
  loadResumeData(lang: string): void {
    this.http
      .get<DataFileModel>(`assets/data/${lang}.json`)
      .subscribe((data) => {
        this.me = data.me;
        this.summary = data.summary;
        this.experience = this.BreakExperience(data.experience, 0, 2, true);
        this.experience2 = this.BreakExperience(
          data.experience,
          2,
          null,
          false,
  ...
  private BreakExperience(
    ...
    const itemsLength =
      length !== null ? length : experience.items.length - start;
    return {
